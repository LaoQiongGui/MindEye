...
extern "C" {
    ...
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippdc" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippcore" )
  #elif defined( _IPP_SEQUENTIAL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippdcmt" )
    ...
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippdc" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippcore" )
  #elif defined( _IPP_PARALLEL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippdcmt" )
