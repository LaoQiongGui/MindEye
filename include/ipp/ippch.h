...
extern "C" {
    ...
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippch" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippcore" )
  #elif defined( _IPP_SEQUENTIAL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippchmt" )
    ...
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippch" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippcore" )
  #elif defined( _IPP_PARALLEL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippchmt" )
...
//               *pNumDst = number of split strings on output;
//
//  Return:
//     ippStsNoErr       Ok
//  ERRORS:
//     ippStsNullPtrErr  pSrc, pDst, dstLen or pNumDst are NULL;
//                       pDst[i] is NULL for i < number of split strings
//     ippStsLengthErr   srcLen is negative;
//                       dstLen[i] is negative for i < number of split strings
//     ippStsSizeErr     *pNumDst is not positive
//  WARNINGS:
//     ippStsOvermuchStrings  the initial number of destination strings is less
//                            than the number of split strings;
...
//                            length of corresponding split string;
//                            split string is truncated to destination length
//                            in this case
*/
...
//
//  Arguments:
//     pSrc    - The pointer to vector to replace.
//     pDst    - The pointer to replaced vector.
//     len     - The length of the vector.
