...
extern "C" {
    ...
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippcc" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippcore" )
  #elif defined( _IPP_SEQUENTIAL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippccmt" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippimt" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippsmt" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippvmmt" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/ippcoremt" )
  #elif defined( _IPP_PARALLEL_DYNAMIC )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippcc" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippcore" )
  #elif defined( _IPP_PARALLEL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippccmt" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippimt" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippsmt" )
    #pragma comment( lib, __FILE__ "/../../../lib" IPP_LIB_SUBDIR_ARCH_SUFFIX "/threaded/ippvmmt" )
...
/* /////////////////////////////////////////////////////////////////////////////
//  Name:       ippiGrayToRGB
//  Purpose:    Converts gray scale image to RGB/BGR image by copying luminance component to color components
//  Parameters:
//     pSrc              Pointer to the source image
//     pDst              Pointer to the destination image
//     roiSize           Size of source and destination ROI in pixels
...
//  Parameters:
//    ippChan     - Intel(R) IPP channels name of the source images. Possible values are ippC1, ippC3 or ippC4.
...
//
//  Purpose:      Converts color filter array image to RGB image with AHD algorithm.
